...
function updateBackgroundImage() {
    ...
    if (windowWidth >= 800) {
        ...
        if (body.classList.contains('dark-mode-variables')) {
            body.style.setProperty('--background-image', "url('img/fundo_mobile.png')");
        } else {
            body.style.setProperty('--background-image', "url('img/fundob_mobile.png')");
        }
    }
}

// Atualizar a imagem de fundo quando a janela for redimensionada
